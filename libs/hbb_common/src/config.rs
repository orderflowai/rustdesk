...
lazy_static::lazy_static! {
    ...
    // pre-filled (and locked) on a fresh install. Upstream 1.4.x dropped the
    // option_env!("RENDEZVOUS_SERVER") build-time override, so we bake it here.
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("remote.orderflowai.io".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["remote.orderflowai.io"];
pub const RS_PUB_KEY: &str = "6qvGuLm3MAH8iP4UzBqj8B9wklIKpnor9CRnBoqkdYY=";
